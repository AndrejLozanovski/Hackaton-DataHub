    ...
    <div className="container-fluid">
      <div className="row py-3">
        ...
        <div className="col-12 col-md-6">
          <div className="content px-3 py-3">
            <h1>{data.title}</h1>
            <p className="pt-3 mb-0 text-dark">
              {data.decs_1}
              {data.desc_2}
            </p>
      ...
      <div className="row pt-3">
        <div className="col-12 py-3">
          ...
          <p className="h6 py-2 text-dark">{data.sub_1}</p>
          <p className="mb-0 text-dark">{data.para_1}</p>
          <p className="text-dark">{data.para_2}</p>
        </div>
        ...
        <div className="col-12 pt-5 pb-3">
          <p className="h6 text-dark">{data.sub_2}</p>
          <p className="mb-0 text-dark">{data.para_1}</p>
          <p className="text-dark">{data.para_1}</p>
        </div>
        <div className="col-12 py-3">
          <p className="h6 text-dark">{data.sub_3}</p>
          <p className="mb-0 text-dark">{data.para_1}</p>
          <p className="text-dark">{data.para_1}</p>
        </div>
      </div>
